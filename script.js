...
function autoClickButton() {
    ...
    var svgText = document.querySelector(".confetti-svg text");

    // Simulate a click on the desired button (adjust the index as needed)
    document.getElementsByClassName("confetti-button")[5].click();

    // Set the SVG text based on the current date
    var currentDate = new Date();
    if (currentDate.getMonth() === 10 && (currentDate.getDate() === 15 || currentDate.getDate() === 19)) {
        svgText.textContent = "Happy Test Day!";
    } else if (currentDate.getMonth() === 11 && (currentDate.getDate() === 7 || currentDate.getDate() === 8)) {
        svgText.textContent = "Happy Constitution Day!";
    } else if (
        (currentDate.getMonth() === 10 && currentDate.getDate() >= 18) || (currentDate.getMonth() === 0 && currentDate.getDate() <= 5)
    ) {
        svgText.textContent = "Happy New Year!";
    } else if (currentDate.getMonth() === 0 && (currentDate.getDate() === 13 || currentDate.getDate() === 14)) {
        svgText.textContent = "Happy Defenders Day!";
    } else if (currentDate.getMonth() === 2 && (currentDate.getDate() === 7 || currentDate.getDate() === 8)) {
        svgText.textContent = "Happy Women's Day!";
    } else if (currentDate.getMonth() === 2 && currentDate.getDate() === 21) {
        svgText.textContent = "Happy Navruz!";
    } else if (
        currentDate.getMonth() === 3 && (currentDate.getDate() === 8 || currentDate.getDate() === 9 || currentDate.getDate() === 10)
    ) {
        svgText.textContent = "Happy Ramazon!";
    }

    // Display and hide the confettiWrapper
    setTimeout(function () {
